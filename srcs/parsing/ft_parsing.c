...
static int ft_parsing_arg(int *j, char *content, char *line, t_shell *shell)
{
    int delta;
...
static int ft_parsing_special_character(int *i, char *line, t_command **command, t_shell *shell)
{
...
static void ft_parsing_dop(char *content, char *line, t_command **command, t_shell *shell)
{
    int i;
    int j;
    int delta;
